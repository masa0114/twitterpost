...
require (dirname(__FILE__).'/TwitterOAuthException.php');
...
class TwitterOAuth extends Config
{
     ...
     * @return array|object
     */
    private function uploadMediaChunked($path, $parameters=array())
    {
        // Init
    ...
    {
        // TODO: key and secret should be rfc 1738 encode
        $key = $consumer->key;
